function determineServerUrl() {
    // In local development we serve Wisk assets from the static folder under
    // /whisk-submodule, so we can short-circuit the logic and return that path.
    const currentUrl = window.location.href;
    if (currentUrl.includes('localhost')) {
        return '/whisk-submodule';
    }
